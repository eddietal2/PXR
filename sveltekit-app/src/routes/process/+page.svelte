      ...
      <div id="section-1" class={$brightnessModelStore === "LIGHT" ? lightBG : darkBG}>
        <div class="w-11/12 md:w-4/5 lg:w-3/5 mx-auto text-center">
          ...
          <h2 class={$brightnessModelStore === "LIGHT" ? lightText : darkText}>
            <span class="text-xl lg:text-3xl text-[#ffcb0a] font-bold uppercase">#XR Application Production Process</span>
          </h2>
        </div>
      </div>
    </section>
          ...
          <div class="w-1/2 lg:w-2/4 mt-20 lg:mt-0 mx-auto bg-[#9999990] content-center">       
            <div class="h-full w-1/2 mx-auto content-center">
              ...
              <g>
                <g>
                    <!-- Inner Circle -->
                    <path fill="#00CF68" d="M179.641,189.565c2.455,0,4.869,0.193,7.223,0.561l36.999-36.998c-13.193-7.048-28.249-11.051-44.221-11.051
                    ...
                    <!-- Arrow -->
                    <path fill="#ffcb0a" d="M415.415,56.64c-1.119-3.539-4.119-6.157-7.775-6.793l-35.449-6.157l-6.156-35.45c-0.637-3.656-3.256-6.655-6.793-7.774
